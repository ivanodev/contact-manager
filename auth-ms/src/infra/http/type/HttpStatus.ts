...
// type HttpStatusType {
//     OK: number | HttpStatusDetail;
//     CREATED: number | HttpStatusDetail;
//     ACCEPTED: number | HttpStatusDetail;
//     NON_AUTHORITATIVE_INFORMATION: number | HttpStatusDetail;
//     NO_CONTENT: number | HttpStatusDetail;
//     INTERNAL_SERVER_ERROR: number | HttpStatusDetail;
// }

// class HttpStatus {

//     static private val: number;
//     static private serieValue: Series;
//     static private reasonPhraseValue: string;

//     static FillHttpStatus(value: number, serie: Series, reasonPhrase: string): any {
//         this.val = value;
//         this.serieValue = serie;
//         this.reasonPhraseValue = reasonPhrase;
//     }

//     // 200 Success
//     static private _OK = HttpStatus.FillHttpStatus;

//     private _CREATED: { value: 201, Serie: Series.SUCCESSFUL, reasonPhrase: "Created" };
//     private _ACCEPTED: { value: 202, Serie: Series.SUCCESSFUL, reasonPhrase: "Accepted" };
//     private _NON_AUTHORITATIVE_INFORMATION: { value: 203, Serie: Series.SUCCESSFUL, reasonPhrase: "Non-Authoritative Information" };
//     private _NO_CONTENT: { value: 204, Serie: Series.SUCCESSFUL, reasonPhrase: "No Content" };
//     private _INTERNAL_SERVER_ERROR: { value: 500, Serie: Series.SERVER_ERROR, reasonPhrase: "Internal Server Error" };

//     static get value(): number {
//         return this.val;        
//     }

//     static get serie(): Series {
//         return this.serieValue;
//     }

//     static get reasonPhrase(): string {
//         return this.reasonPhraseValue;
//     }
// }
